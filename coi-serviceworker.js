...
/*
 * يُمكّن «العزل عبر الأصول» (cross-origin isolation) على GitHub Pages عبر عامل
 * خدمة يضيف ترويسات COOP/COEP، فيتاح SharedArrayBuffer ومن ثمّ WASM متعدّد
 * الخيوط — ما يسرّع استدلال Whisper كثيراً. (راجع: لماذا كان بطيئاً.)
 */
  ...
  (() => {
    ...
    if (controlling) {
      ...
      n.serviceWorker.controller.postMessage({
        ...
        value: reloadToDegrade ? false : coi.coepCredentialless(),
      });
      if (reloadToDegrade) {
